...
function DailyEssentials() {
  ...
  const products = [
    {
      id: 1,
      title: "DOUBLE HORSE JAGGERY POWDER 600GM",
    ...
    {
      id: 2,
      title: "DOUBLE HORSE EASY PALAPPAM 1KG",
      image: "https://bestoptions.uk/wp-content/uploads/2025/03/double-horse-appam-idiyappam-1kg.jpg",
      price: 2.99,
    ...
    {
      id: 3,
      title: "EASY PALAPPAM MIX KTS 1KG",
      image: "https://bestoptions.uk/wp-content/uploads/2025/03/double-horse-appam-idiyappam-1kg.jpg",
      price: 2.95,
      categories: ["Cereals & Breakfast", "Grocery & Essentials"]
    },
    ...
    {
      id: 5,
      title: "AMMACHIES MASALA DOSA 400GM",
      image: "https://bestoptions.uk/wp-content/uploads/2025/03/double-horse-appam-idiyappam-1kg.jpg",
      price: 2.49,
      categories: ["Cereals & Breakfast", "Frozen Foods", "Grocery & Essentials"],
      isOutOfStock: true
    ...
    {
      id: 6,
      title: "DD FAMILY PACK RESTAURANT POROTTA 908GM",
      image: "https://bestoptions.uk/wp-content/uploads/2025/03/double-horse-appam-idiyappam-1kg.jpg",
      price: 3.89,
      categories: ["Cereals & Breakfast", "Frozen Foods", "Grocery & Essentials"]
    },
  ...
  return (
    <div className="w-full bg-[#EFF5EE] py-6 sm:py-8 md:py-10">
      <div className="max-w-[1800px] mx-auto px-4 sm:px-6">
        <h2 className="text-2xl sm:text-3xl font-bold text-center text-green-800 mb-4 sm:mb-6 md:mb-8">Daily Essentials</h2>
